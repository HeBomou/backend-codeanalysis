...
public class ProjectServiceTest {
    ...
    public void testGetProjectAll1() {
        ...
        var expS1 = new SubgraphAllVo(4L, 0d, Arrays.asList(expC1),
                new SubgraphDynamicVo(4L, "Default subgraph", null)); // TOD:
    ...
    public void testGetProjectProfile() {
        ...
        // 验证数据
        var vo = new ProjectProfileVo(10000L, "One project", 0, 34, 56, 4, 2020, 20, 20, 0);
        // 执行
    ...
    public void testAddSubgraph1() {
        ...
        var svo = new SubgraphAllVo(17L, 0.555d, connectiveDomainsVo, new SubgraphDynamicVo(17L, "subgraphdd", null)); // TOD:
    ...
    public void testUpdateSubgraphDynamic1() {
        service.updateSubGraphDynamic(2L, new SubgraphDynamicVo(1L, "newName", null)); // TOD:
    ...
    public void testUpdateVertexDynamic1() {
        ...
        // Mockito.verify(vertexPositionDynamicData).save(new
        // VertexPositionDynamicPo(456L, 27L, 45.5f, 92.2f));
    }
