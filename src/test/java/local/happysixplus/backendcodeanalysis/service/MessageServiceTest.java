...
class MessageServiceTest {
    ...
    void addMessage() throws Exception {
        // 执行
        var messageVo = new MessageVo(null, 1L, 2L, "xxxx", "123123");
        var messagePo = new MessagePo(null, 1L, 2L, "xxxx", "123123");
        Mockito.when(data.save(messagePo)).thenReturn(new MessagePo(1L, 1L, 2L, "xxxx", "123123"));
    ...
    @Test
    void getMessage() {
        var po1 = new MessagePo(15L, 44L, 45L, "fsfs", "1");
        var po2 = new MessagePo(16L, 44L, 45L, "zszs", "2");
        var po3 = new MessagePo(17L, 44L, 45L, "ssss", "3");
        var pos1 = Arrays.asList(po1, po2, po3);
        Mockito.when(data.findBySenderIdAndReceiverId(44L, 45L)).thenReturn(pos1);

        var po4 = new MessagePo(18L, 45L, 44L, "fsfsfs", "4");
        var po5 = new MessagePo(19L, 45L, 44L, "zszszs", "5");
        var po6 = new MessagePo(20L, 45L, 44L, "ssssss", "6");
        var pos2 = Arrays.asList(po4, po5, po6);
        Mockito.when(data.findBySenderIdAndReceiverId(45L, 44L)).thenReturn(pos2);

        var vo1 = new MessageVo(15L, 44L, 45L, "fsfs", "1");
        var vo2 = new MessageVo(16L, 44L, 45L, "zszs", "2");
        var vo3 = new MessageVo(17L, 44L, 45L, "ssss", "3");
        var vo4 = new MessageVo(18L, 45L, 44L, "fsfsfs", "4");
        var vo5 = new MessageVo(19L, 45L, 44L, "zszszs", "5");
        var vo6 = new MessageVo(20L, 45L, 44L, "ssssss", "6");
