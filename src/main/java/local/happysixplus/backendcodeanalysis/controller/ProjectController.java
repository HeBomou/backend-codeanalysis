...
public class ProjectController {
     ...
     */
    @GetMapping
    public List<ProjectBasicAttributeVo> getProjectBasicAttribute(@RequestParam(required = false, defaultValue = "-1") Long userId, @RequestParam(required = false, defaultValue = "-1") Long groupId) {
        return service.getProjectBasicAttribute(userId, groupId);
    }
