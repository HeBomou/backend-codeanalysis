...
public class JavaShellUtil {
    ...
    public static void ExecClone(String projectName,String url){
        try{
            ...
            String command="mkdir temp/"+projectName+" ; git clone "+url+" temp/"+projectName+" ; cd temp/"+projectName+" ;"+"/Users/hebo/Workspace/Homework/se3/backend-codeanalysis/mvnw package";
            String[] commands=new String[]{"/bin/sh","-c",command};
